...
function mergeOnCar(fn,fp)
{
	...
	// change these values and letters as they change from Andy 
		...
		frontThreeQuarter.push(mrgFileName+"_07","pr");
		frontThreeQuarter.push(mrgFileName+"_08","df");
	
		var rearThreeQuarter = [];
		rearThreeQuarter.push(mrgFileName+"_06","st");
		rearThreeQuarter.push(mrgFileName+"_09","pf");
		...
		//	alert("full stop here");
			...
			//tmpPathItem.makeSelection(0);
			//makeMask(); // this is path 2 to a pixel
